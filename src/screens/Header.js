          ...
          <div className={styles.header}>
               <div className={styles.container}>
                    <div className={styles.logodiv}>
                         <Link className={`${styles.logo} ${b}`} to="/">
                              M.fund
                         </Link>
                    </div>
                    ...
                    <nav>
                         <ul className={styles.navUl}>
                              <li className={styles.navLi1}>
                                   <Link
                                        className={`${styles.navLink1} ${x} ${font}`}
                                        to="/main/alexi"
                                   >
                                        {t('ALEXI')}
                                   </Link>
                                   <ul className={styles.subNav1}>
                                        <li>
                                             <Link
                                                  ...
                                                  className={`${styles.subNavLink} ${font}`}
                                             >
                                                  {t('Biography')}
                                             </Link>
                                        </li>
                              ...
                              <li className={styles.navLi2}>
                                   <Link
                                        className={`${styles.navLink2} ${y} ${font}`}
                                        to="/main/vakhtang"
                                   >
                                        {t('VAKHTANG')}
                                   </Link>
                              ...
                              <li className={styles.navLi3}>
                                   <Link
                                        className={`${styles.navLink3} ${z} ${font}`}
                                        to="/main/foundation"
                                   >
                                        {t('FOUNDATION')}
                                   </Link>
                              ...
                              <li className={styles.navLi4}>
                                   <Link
                                        className={`${styles.navLink4} ${a} ${font}`}
                                        to="/main/projects"
                                   >
                                        {t('PROJECTS')}
                                   </Link>
                              ...
                              <li className={styles.navLi5}>
                                   <Link
                                        className={`${styles.navLink5} ${s} ${font}`}
                                        to="/main/contact"
                                   >
                                        {t('CONTACT')}
                                   </Link>
                    ...
                    <div className={styles.languages}>
                         ...
                         <span>/</span>
                         <a
                              className={`${styles.lngBtn} ${sch}`}
                              onClick={changeLanguageGEO}
                         >
                              GEO
                         </a>
                    </div>
