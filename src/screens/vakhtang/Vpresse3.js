    ...
    return (<div>      
        ...
        <div className={styles.parrentDiv}>
               ...
               <div className={styles.presseTxt} >
                     ...
                     <p>
                     28)   This was the celebration of the Russian school of music. The orchestra acquired radiance under Vakhtang Matchavariani. The composer and the director were parts of one whole. It is hard to imagine any better performance of Shostakovich’s Symphony Number Six than in the interpretation given by Matchavariani. LÜBECKER NACHRICHTEN. WOLFGANG TSCHECHNE. GERMANY.
    
                     </p>
    
    
                     <p>
                     29)   E. Mikeladze Georgia State Symphony is a high-class orchestra characterized with lofty emotionality and the precision of sounding. Conductor Matchavariani governs and controls the whole process with a gentle hand, which creates a great impression. RHEINISCHE POST. HEIDE OEHMEN. GERMANY.
                     </p>
    
    
    
                    <p>
                    30)   Georgia State Symphony is an orchestra of a first class international category. Maestro Matchavariani’s movements are light, individual and clearly delineated as if dancing a minuet. He conducts the orchestra with determination using those invisible ropes. WESTDEUTSCHE ZEITUNG. HORST M. BECKER. GERMANY.
                    </p>
