...
const resources = {
     ...
     ka: {
          translation: {
               ...
               Photos: 'ფოტოები',
               Team: 'გუნდი',
               'Alexi And Vakhtang Matchavariani':
                    'ალექსი და ვახტანგ მაჭავარიანის',
               ...
               'tasks to be executed over a fixed period':
                    'საუკეთესო ნამუშევრების ან საუკეთესო მონაწილეების გამოვლენის მიზნით',
               // Projects
